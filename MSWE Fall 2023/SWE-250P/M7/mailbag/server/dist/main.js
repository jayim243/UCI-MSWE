...
// Get list of messages in a subdirectory of a mailbox.
app.get("/mailboxes/:mailbox/:subdirectory", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var subdirectoryPath, imapWorker, messages, inError_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("GET /mailboxes (2)", inRequest.params.mailbox, inRequest.params.subdirectory);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                subdirectoryPath = "".concat(inRequest.params.mailbox, "/").concat(inRequest.params.subdirectory);
                imapWorker = new IMAP.Worker(ServerInfo_1.serverInfo);
                return [4 /*yield*/, imapWorker.listMessages({
                        mailbox: subdirectoryPath
                    })];
            case 2:
                messages = _a.sent();
                console.log("GET /mailboxes (2): Ok", messages);
            ...
            case 3:
                inError_3 = _a.sent();
                console.log("GET /mailboxes (2): Error", inError_3);
                inResponse.send("error");
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
app.get("/messages/:mailbox/:id", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var imapWorker, messageBody, inError_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                inError_4 = _a.sent();
                console.log("GET /messages (3): Error", inError_4);
                inResponse.send("error");
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
// Get a message's plain text body in a subdirectory.
app.get("/messages/:mailbox/:subdirectory/:id", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var subdirectoryPath, imapWorker, messageBody, inError_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("GET /messages (3)", inRequest.params.mailbox, inRequest.params.subdirectory, inRequest.params.id);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                subdirectoryPath = "".concat(inRequest.params.mailbox, "/").concat(inRequest.params.subdirectory);
            ...
            case 3:
                inError_5 = _a.sent();
                console.log("GET /messages (3): Error", inError_5);
                inResponse.send("error");
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
// Delete a message in a subdirectory.
app.delete("/messages/:mailbox/:subdirectory/:id", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var subdirectoryPath, imapWorker, inError_7;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("DELETE /messages");
            ...
            case 3:
                inError_7 = _a.sent();
                console.log("DELETE /messages: Error", inError_7);
                inResponse.send("error");
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
// To test, use CLI:
// curl -v -d "{ \"to\" : \"yimj3@uci.edu\", \"from\" : \"yimj3@uci.edu\", \"subject\" : \"This is a test\", \"message\" : \"If you see this then it worked!\" }" -H "Content-Type: application/json" -X POST http://localhost/messages
// Send a message.
app.post("/messages", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var smtpWorker, inError_8;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                inError_8 = _a.sent();
                console.log("POST /messages: Error", inError_8);
                inResponse.send("error");
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
// curl -X POST -H "Content-Type: application/json" -d '{"name": "John Doe", "email": "john.doe@example.com"}' http://localhost/contacts
// List contacts.
app.get("/contacts", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var contactsWorker, contacts, inError_9;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                inError_9 = _a.sent();
                console.log("GET /contacts: Error", inError_9);
                inResponse.send("error");
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
app.post("/contacts", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                inError_10 = _a.sent();
                console.log("POST /contacts: Error", inError_10);
                inResponse.send("error");
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
