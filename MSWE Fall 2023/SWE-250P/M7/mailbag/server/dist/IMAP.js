            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        finalMessages = [];
                        messages
                            .sort(function (a, b) { return new Date(b.envelope.date).getTime() - new Date(a.envelope.date).getTime(); }) // new feature: sorting by most recent emails
                            .forEach(function (inValue) {
                            finalMessages.push({
                                id: inValue.uid,
