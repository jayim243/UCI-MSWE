...
app.get("/mailboxes/:mailbox/:subdirectory",
  async (inRequest: Request, inResponse: Response) => {
    console.log("GET /mailboxes (2)", inRequest.params.mailbox, inRequest.params.subdirectory);
    try {
      const subdirectoryPath = `${inRequest.params.mailbox}/${inRequest.params.subdirectory}`;
      const imapWorker: IMAP.Worker = new IMAP.Worker(serverInfo);
      const messages: IMAP.IMessage[] = await imapWorker.listMessages({
...
app.get("/messages/:mailbox/:subdirectory/:id",
  async (inRequest: Request, inResponse: Response) => {
...
app.delete("/messages/:mailbox/:subdirectory/:id",
  async (inRequest: Request, inResponse: Response) => {
    console.log("DELETE /messages");
    try {
      const subdirectoryPath = `${inRequest.params.mailbox}/${inRequest.params.subdirectory}`;
